...
The total weight og trash collected by Professor Trash wheel is:
...
- For the import process, I had to skip the first row on the csv because it contained information on the variables and the actual variables were stored in the second column. I also specified the na= "." so that the . would be converted to an empty value. Then I could use drop_na to remove those rows

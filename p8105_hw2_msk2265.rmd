...
The resulting dataset contains 94 participants, their sex, baseline age, education, age at onset, carrier status, and 4 additional time points of mci data. Not all participants have all 4 time points of data. The average mci at baseline is `r mean(pull(mci_df, baseline))` and at time 8 is `r mean(pull(mci_df, time_8), na.rm = TRUE)`. 

...
would be converted to an empty value. Then I could use drop_na to remove
those rows. The data set includes the subject ID, current age, sex,
education, apoe4 carrier or not, and the age of onset.
...
The average baseline age is 65.05 for all of the recruted participants
and it is 65.61 for the participants that developed MCI.
...
the proportion of women who are apoe4 carriers is 30:16 or 30/46
participants who developed MCI. I used the MCI_baseline data after all
of the subjects who did not developme MCI were removed.
...
since the baseline contains 97 participants and the amyloid dataset
...
The resulting dataset contains 94 participants, their sex, baseline age,
education, age at onset, carrier status, and 4 additional time points of
mci data. Not all participants have all 4 time points of data. The
average mci at baseline is 0.1095434 and at time 8 is 0.1061211.
